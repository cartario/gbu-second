...
const items = {
  ...
  contacts: {
    lusinovka: {
      phones: ['+7(499) 237-90-40', '+7-903-253-07-73'],
      adminName: 'Семяник Наталья Мирославовна',
    },
    trof: {
      phones: ['+7(495)679-92-93', '+7(965)336-06-83'],
      adminName: 'Тикот Анна Николаевна',
    },
    social: [
      {
        title: 'Вконтакте',
      ...
      <main className="contacts">
        ...
        <div className="contacts__info">
          ...
          <div className="contacts__block">
            ...
            {contacts.lusinovka.phones.map((phone)=><span key={phone}>{phone},  </span> )}
            
            </p>
            <p className="contacts__admin">Администратор: {contacts.lusinovka.adminName} </p>
          </div>
          ...
          <div className="contacts__block">
            ...
            {contacts.trof.phones.map((phone)=><span key={phone}>{phone},  </span> )}
            
            </p>
            <p className="contacts__admin">
              Руководитель структурного подразделения: {contacts.trof.adminName}
            </p>
          </div>
